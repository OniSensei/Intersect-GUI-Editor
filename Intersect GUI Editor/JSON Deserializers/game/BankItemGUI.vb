...
Module BankItemGUI
    ...
    Public Class Children
        Public Property BankItemIcon As BankItemIcon
        Public Property BankItemValue As IntersectLabel
    End Class

    Public Class BankItemIcon
        Public Property Bounds As String
        Public Property Padding As String
        Public Property AlignmentEdgeDistances As String
        Public Property AlignmentTransform As String
    ...
    Public Sub LoadBankItemGUI(ByVal jsonfile As String)
        ...
        Form1.BankItemValue.Width = BankItemValueBounds(2)
        Form1.BankItemValue.Height = BankItemValueBounds(3)

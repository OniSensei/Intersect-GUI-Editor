...
Module CharacterSelectionWindowGUI
    ...
    Public Class Children
        Public Property CharacterSelectionHeader As CharacterSelectionHeader
        Public Property CharacterNameLabel As CharSelectCharacterNameLabel
        Public Property CharacterInfoLabel As CharacterInfoLabel
        Public Property CharacterContainer As CharSelectCharacterContainer
        Public Property PlayButton As PlayButton
        Public Property DeleteButton As DeleteButton
        Public Property NewButton As NewButton
        Public Property LogoutButton As LogoutButton
    End Class

    Public Class CharacterSelectionHeader
        Public Property Bounds As String
        Public Property Padding As String
        Public Property AlignmentEdgeDistances As String
        Public Property AlignmentTransform As String
    ...
    Public Class CharSelectCharacterNameLabel
        Public Property Bounds As String
        Public Property Padding As String
        Public Property AlignmentEdgeDistances As String
        Public Property AlignmentTransform As String
    ...
    Public Class CharacterInfoLabel
        Public Property Bounds As String
        Public Property Padding As String
        Public Property AlignmentEdgeDistances As String
        Public Property AlignmentTransform As String
    ...
    Public Class CharSelectCharacterContainerChildren
        Public Property NextCharacterButton As NextCharacterButton
        Public Property PreviousCharacterButton As PreviousCharacterButton
    End Class

    Public Class NextCharacterButton
        Public Property Bounds As String
        Public Property Padding As String
        Public Property AlignmentEdgeDistances As String
        Public Property AlignmentTransform As String
    ...
    Public Class PreviousCharacterButton
        Public Property Bounds As String
        Public Property Padding As String
        Public Property AlignmentEdgeDistances As String
        Public Property AlignmentTransform As String

...
Module InputBoxGUI
    ...
    Public Sub LoadInputBoxGUI(ByVal jsonfile As String)
        ...
        Form1.TitleBar.Location = New Point(InputBoxTitleBarBounds(0), InputBoxTitleBarBounds(1))
        Form1.TitleBar.Width = InputBoxTitleBarBounds(2)
        Form1.TitleBar.Height = InputBoxTitleBarBounds(3)
